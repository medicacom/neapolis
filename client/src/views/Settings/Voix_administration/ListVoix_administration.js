...
import { fetchVoix_administration, voix_administrationChangeEtat, voix_administrationDeleted } from "../../../Redux/voix_administrationReduce";
...
function ListVoix_administration({onlineStatus}) {
      ...
      },
      {
        ...
        Cell: ({ cell, row }) => (
          <div className="actions-right block_action">
            <Button
              onClick={() => {
                navigate.push("/voix_administration/update/" + cell.row.original.id);
              }}
              variant="warning"
              size="sm"
  ...
  const storeVoix_administration = useCallback(async (resVoix_administration) => {
  ...
  async function clearVoix_administration(resVoix_administration) {
    let txVoix_administration = db.transaction("voix_administrations", "readwrite");
  ...
  const getVoix_administration = useCallback(
    async () => {
        ...
        <Row>
          <Col md="12">
            ...
            >
              ...
              Ajouter un voix_administration
            </Button>
          </Col>

          <Col md="12">
            <h4 className="title">Liste des voix administration</h4>
